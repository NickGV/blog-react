  ...
  return (
    ...
    >
      <div className="flex gap-3">
        ...
        <div>
          <h1 className="font-bold text-sm md:text-lg">{post.title}</h1>
          <p className="text-sm text-gray-600 ">{post.tags[0]}</p>
        </div>
      </div>
      <button className="flex flex-end mr-8" onClick={handleDeleteClick}>
        <i className="fa-solid fa-trash text-xl md:text-2xl hover:scale-125 hover:text-orange-600 transition-all"></i>
      </button>
    </NavLink>
  );
};
