...
export const NavBar = () => {
  return (
    <div className="bg-gray-bg text-white  fixed md:relative md:top-0 md:left-0 md:h-screen md:w-64 lg:h-screen lg:w-64 lg:left-0 lg:top-0 h-16 w-full bottom-0 left-0 top-auto">
      <div className="mt-4">
